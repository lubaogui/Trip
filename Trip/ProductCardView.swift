...
class ProductCardView: UIView {
    ...
    */
    ...
    func loadData(product: Product) {
        productImageView.kf_setImageWithURL(NSURL(string: product.coverImageUrl!)!, placeholderImage: UIImage(named: "product_default_coverimage"), optionsInfo: nil, progressBlock: nil, completionHandler: nil);
